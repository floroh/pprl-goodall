...
**link_selection_strategy** | **str** |  | [optional] 
**update_type** | **str** |  | [optional] 
**initial_threshold** | **float** |  | [optional] 
**stop_update_when_clerical_review_budget_is_reached** | **bool** |  | [optional] 
**budget** | **int** |  | [optional] 
**error_rate** | **float** |  | [optional] 
**attribute_weight_method** | **str** |  | [optional] 
**initial_attribute_weights** | **Dict[str, float]** |  | [optional] 
**attribute_error_rates** | **Dict[str, float]** |  | [optional] 
