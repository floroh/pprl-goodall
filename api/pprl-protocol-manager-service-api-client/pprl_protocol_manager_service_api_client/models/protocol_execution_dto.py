...
class ProtocolExecutionDto(BaseModel):
    """
    ProtocolExecutionDto
    """ # noqa: E501
    protocol_id: Optional[StrictStr] = Field(default=None, alias="protocolId")
    number_of_steps: Optional[StrictInt] = Field(default=None, alias="numberOfSteps")
    step_to_stop: Optional[StrictStr] = Field(default=None, alias="stepToStop")
    __properties: ClassVar[List[str]] = ["protocolId", "numberOfSteps", "stepToStop"]
