...
class ProjectSecretManagementApi:
    ...
    def add(
        ...
        :param secret_dto: (required)
        :type secret_dto: SecretDto
    ...
    def _add_serialize(
        ...
        if secret_dto is not None:
            _body_params = secret_dto
