...
from pprl_data_owner_service_api_client.models.record_modifier import RecordModifier
from pprl_data_owner_service_api_client.models.selector_record import SelectorRecord
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class SelectiveRecordModifier(BaseModel):
    """
    SelectiveRecordModifier
    """ # noqa: E501
    modifier: Optional[RecordModifier] = None
    selector: Optional[SelectorRecord] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "modifier": RecordModifier.from_dict(obj["modifier"]) if obj.get("modifier") is not None else None,
            "selector": SelectorRecord.from_dict(obj["selector"]) if obj.get("selector") is not None else None,
            "@class": obj.get("@class")
        })
        return _obj
