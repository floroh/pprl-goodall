...
class EncodingCreationResponseDto(BaseModel):
    """
    Response of creating an encoding definition.
    """ # noqa: E501
    request: Optional[EncodingCreationRequestDto] = Field(default=None, description="Request description with auto-generated dataset-based properties")
    encoding: Optional[EncodingDto] = None
    __properties: ClassVar[List[str]] = ["request", "encoding"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": EncodingCreationRequestDto.from_dict(obj["request"]) if obj.get("request") is not None else None,
            "encoding": EncodingDto.from_dict(obj["encoding"]) if obj.get("encoding") is not None else None
        })
        return _obj
