...
from pprl_data_owner_service_api_client.models.attribute_modifier_object import AttributeModifierObject
from pprl_data_owner_service_api_client.models.selector_string import SelectorString
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class SelectiveAttributeModifier(BaseModel):
    """
    SelectiveAttributeModifier
    """ # noqa: E501
    modifier: Optional[AttributeModifierObject] = None
    selector: Optional[SelectorString] = None
    var_class: StrictStr = Field(alias="@class")
    __properties: ClassVar[List[str]] = ["modifier", "selector", "@class"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "modifier": AttributeModifierObject.from_dict(obj["modifier"]) if obj.get("modifier") is not None else None,
            "selector": SelectorString.from_dict(obj["selector"]) if obj.get("selector") is not None else None,
            "@class": obj.get("@class")
        })
        return _obj
