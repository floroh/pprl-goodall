...
class SecretDto(BaseModel):
    ...
    """ # noqa: E501
    project: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique name of the record-linkage project")
    secret: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Secret value")
    __properties: ClassVar[List[str]] = ["project", "secret"]
