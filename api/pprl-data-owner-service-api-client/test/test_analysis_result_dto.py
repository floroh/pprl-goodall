    ...
    def make_instance(self, include_optional) -> AnalysisResultDto:
        ...
        if include_optional:
            return AnalysisResultDto(
                ...
                description = '',
                report_groups = {
                    'key' : pprl_data_owner_service_api_client.models.report_group.ReportGroup(
                        name = '', 
                        reports = {
                            'key' : pprl_data_owner_service_api_client.models.report.Report(
                                name = '', 
                                type = 'TEXT', 
                                report = '', 
                                table = pprl_data_owner_service_api_client.models.serializable_table.SerializableTable(
                                    name = '', 
                                    header = [
                                        ''
                                        ], 
