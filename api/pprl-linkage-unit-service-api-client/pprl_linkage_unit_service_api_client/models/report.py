...
class Report(BaseModel):
    ...
    table: Optional[SerializableTable] = None
    __properties: ClassVar[List[str]] = ["name", "type", "report", "table"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['TEXT', 'TABLE']):
            raise ValueError("must be one of enum values ('TEXT', 'TABLE')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "table": SerializableTable.from_dict(obj["table"]) if obj.get("table") is not None else None
        })
        return _obj
