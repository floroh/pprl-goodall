...
class ResultRequest(BaseModel):
    ...
    pair_properties: Optional[List[StrictStr]] = Field(default=None, alias="pairProperties")
    __properties: ClassVar[List[str]] = ["projectId", "pairProperties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pairProperties": obj.get("pairProperties")
        })
        return _obj
