...
class SearchResultEntryDto(BaseModel):
    """
    SearchResultEntryDto
    """ # noqa: E501
    found_id: Optional[RecordIdDto] = Field(default=None, alias="foundId")
    similarity: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["foundId", "similarity"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of found_id
        if self.found_id:
            _dict['foundId'] = self.found_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "foundId": RecordIdDto.from_dict(obj["foundId"]) if obj.get("foundId") is not None else None,
