...
class RecordDto(BaseModel):
    ...
    attributes: Optional[Dict[str, AttributeDto]] = None
    __properties: ClassVar[List[str]] = ["id", "datasetId", "encodingId", "attributes"]
