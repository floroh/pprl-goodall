...
def render_protocol_introduction():
    ...
    <img style="margin: 20px 0;" width="80%" src="app/static/images/linkage-motivation.jpg">
    </div>
    <div width="100%" align="center">
    <img style="margin: 20px 0;" width="80%" src="app/static/images/pprl-ttp-workflow.png">
    </div>
                """,
            unsafe_allow_html=True,
        )
    ...
    <div width="100%" align="center">
    <img style="margin: 20px 0;" width="90%" src="app/static/images/bloom-filter-encoding.png">
    </div>
    ...
    <div width="100%" align="center">
    <img style="margin: 20px 0;" width="40%" src="app/static/images/frequency-alignment.png">
    </div>
                """,
            unsafe_allow_html=True,
        )
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="width: 45%; text-align: left;">
    <ul>
      ...
      <li><strong>Active Learning:</strong> Two active learning processes: <code>AL<sub>R</sub></code> (trains <code>M<sub>R</sub></code> using <code>M<sub>A</sub></code> as an oracle) and <code>AL<sub>A</sub></code> (human oracle provides labels for <code>M<sub>A</sub></code>). Revised labels from lower layers update models in upper layers to improve classification accuracy iteratively.</li>
